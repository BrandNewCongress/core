defmodule Core.ActController do
  ...
  defp render_call(conn, params, district) do
    ...
    %{candidate: candidate, closest_candidate: closest_candidate} = candidate_options(district)
    ...
    render(
      ...
      [
        ...
        callable_candidates: callable_maps,
  ...
  defp is_callable(%{
         "slug" => _slug,
         "metadata" => %{"callable" => "Callable", "time_zone" => time_zone}
       }) do
    ...
    case weekday do
      n when n in [7] ->
        ...
        local_hours >= 12 and local_hours < 21
