defmodule Core.OsdiController do
  ...
  def record_contact(conn, record_contact_body = %{"contact" => %{}}) do
    ...
    json(
      ...
      Map.take(
        response,
        ~w(action_date contact_effort_id contact_type origin_system status_code target_id success identifiers contactor_id)a
      )
    )
  end

  defp do_remove_tags(person, %{"remove_tags" => tags_to_remove}),
    do: Osdi.Person.remove_tags(person, tags_to_remove)
